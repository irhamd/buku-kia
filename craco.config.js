            ...
            options: {
                lessLoaderOptions: {
                    lessOptions: {
                        ...
                        modifyVars: {
                            '@primary-color': 'rgb(222, 104, 169)', // primary color for all components
                            ...
                            '@border-color-base': '#de68a99e', // major border color
                            '@box-shadow-base': '0 3px 6px -4px rgba(171, 71, 188, 0.32), 0 6px 16px 0 rgba(171, 71, 188, 0.32),0 9px 28px 8px rgba(171, 71, 188, 0.32)', // major shadow for layers
                            ...
                            '@input-hover-border-color': 'rgb(222, 104, 169)',
