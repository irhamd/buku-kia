...
import { AppstoreOutlined, DislikeOutlined, EnvironmentOutlined, FallOutlined, MailOutlined, QuestionCircleOutlined, SettingOutlined, SisternodeOutlined, SmileOutlined, SolutionOutlined, UserOutlined, WhatsAppOutlined } from '@ant-design/icons';
    ...
    return (
        <div>
            <Menu mode="horizontal" style={{ background: "#ffc107", fontWeight: "bolder" }}>
                <Item key="mail" icon={<MailOutlined />} onClick={pr.showPasien}>
                    Pasien EB
                </Item>
